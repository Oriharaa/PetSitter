...
public class MReplyController {
	...
	@RequestMapping(value="/read_Reply.bo", produces="application/json; charset=UTF-8")  //댓글 리스트
	...
	@RequestMapping(value="/write_Reply.bo", produces="application/json; charset=UTF-8") //댓글 작성 
  ...
  @RequestMapping(value="/update_Reply.bo", produces="application/json; charset=UTF-8") //댓글 수정)
  ...
  @RequestMapping(value="/delete_Reply.bo",  produces="application/json; charset=UTF-8") //댓글 삭제
