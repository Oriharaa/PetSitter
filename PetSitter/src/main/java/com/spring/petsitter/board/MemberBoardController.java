...
public class MemberBoardController {
	...
	public List<ReviewBoardVO> getPeopleJSONGET() {
		List<ReviewBoardVO> review_list = memberboardService.getReviewList();
	...
	public List<ReviewBoardVO>updateLike_count(ReviewBoardVO vo) {
		...
		List<ReviewBoardVO> review_list = memberboardService.updateLike_count(vo);
	...
	public List<ReviewBoardVO>updateLike_count2(ReviewBoardVO vo) {
		List<ReviewBoardVO> review_list = memberboardService.updateLike_count2(vo);
