 	...
 	<colgroup>
	  ...
	  <tbody>
	    <tr style = "color : #5e5e5e;">
		  ...
		  <td rowspan="3"><a href = "home.me"><input type="button" class="pet_talk mybtn" value="교객과의 소통"></a></td>
		</tr>
	  ...
	  <tbody>
	    <tr style = "color : #5e5e5e;">
		  ...
		  <td rowspan="3"><button type="button" class="font-size-16 main_whitefont mybtn" data-toggle="modal" data-target="#staticBackdrop02">답글 남기기</button></td>
		</tr>
	  ...
	  <tbody>
	    <tr style = "color : #5e5e5e;">
		  ...
		  <td rowspan="3">1</td>
		  <td rowspan="3">30,000원</td>
		  <td rowspan="3"><div class="review_complete">답글 완료</div></td>
		</tr>
      		...
      		<div class = "col-12">
      			<table>
      				<tr>
      					...
      					<input type="text" id="datePicker_start" class="form-control dateP" placeholder="시작 날짜" style = "height : 41px;" width ="150px">
      					제외 종료날짜
      					<input type="text" id="datePicker_end" class="form-control dateP" placeholder="종료 날짜" style = "height : 41px;" width ="150px">
      					</td>
      				</tr>
      				<tr>
      					<td></td>
      				...
      				<tr>
      					<td></td>
      					<td><button type="button" class="modalbt04">추가</button></td>
      				</tr>
      		...
      		<div class = "col-12">
      			<table class="table table-sm table-hover table-striped" style = "font-size : 15px;">
      				...
      				<tr>
      					<th>이메일 변경 :</th>
      					<td colspan = "2" >
      					<input type="text" name="str_email01" id="str_email01" style="width:124px" class= "float-left">
								<div class= "float-left">@</div>
   							<input type="text" name="str_email02" id="str_email02" style="width:124px;" disabled value="naver.com" class= "float-left" width = "124px"> 
						    <select style="width:124px;margin:0 10px;" name="selectEmail" id="selectEmail" class= "float-left">
							...
							<tr>
      					<th>주소 변경:</th>
      					<td><input type = "text" value = "주소 버튼을 누르세요." size = "30"  class = "float-left" id="sample5_address">
      					<input type="button" class="btn modalbt03 float-left" onclick="sample5_execDaumPostcode();" value="주소 검색 ">
      					</td>
      				</tr>
      				<tr>
      					<th>상세 주소 :</th>
      				...
      				<tr>
      					<th>성별 : </th>
      					<td>
									<input type="radio" name="gender" value="남자" class = "float-left radioC" checked/><div class = "float-left">남자</div>
									<input type="radio" name="gender" value="여자" class = "float-left radioC2" /><div class = "float-left">여자</div>
								</td>
							</tr>
      				<tr>
      					<th>위탁 1시간 가격(24h 24000원) :</th>
      					<td colspan = "2" style = "text-align : left;"><input type = "text" value = "1000" size = "10" class = "float-left">원</td>
      				</tr>
      				<tr>
      					<th>방문 30분 가격(기본 1시간은 15000원) :</th>
      					<td colspan = "2" style = "text-align : left;"><input type = "text" value = "5000" size = "10" class = "float-left">원</td>
      				</tr>
      				<tr>
      					<th>자격증 :</th>
      					<td colspan = "2"><input type = "text" value = "" size = "50" class = "float-left"></td>
      				</tr>
      				<tr>
      					<th>자격증 사진 :</th>
      					<td colspan = "2">
      						...
      						<label for="ex_filename10">업로드</label><input type="file" id="ex_filename10" class="upload-hidden"> </div>
      					</td>
      				</tr>
      				<tr>
      					<th>대형견 가능 : </th>
      					<td>
									<input type="radio" name="bigpet" value="y" class = "float-left radioC" checked/><div class = "float-left">가능</div>
									<input type="radio" name="bigpet" value="n" class = "float-left radioC2" /><div class = "float-left">불가능</div>
								</td>
							</tr>
							<tr>
      					<th>노견 케어가능 : </th>
      					<td>
									<input type="radio" name="oldpet" value="y" class = "float-left radioC" checked/><div class = "float-left">가능</div>
									<input type="radio" name="oldpet" value="n" class = "float-left radioC2" /><div class = "float-left">불가능</div>
								</td>
							</tr>
							<tr>
      					<th>고객 집 픽업 : </th>
      					<td>
									<input type="radio" name="pickup" value="y" class = "float-left radioC" checked/><div class = "float-left">가능</div>
									<input type="radio" name="pickup" value="n" class = "float-left radioC2" /><div class = "float-left">불가능</div>
								</td>
							</tr>
							<tr>
      					<th>마당 유무 : </th>
      					<td>
									<input type="radio" name="yard" value="y" class = "float-left radioC" checked/><div class = "float-left">있음</div>
									<input type="radio" name="yard" value="n" class = "float-left radioC2" /><div class = "float-left">없음</div>
								</td>
							</tr>
      				<tr>
								<th class = "font-size-14">소개(예약페이지에서 고객 확인.) :</th>
								<td><textarea name="inputstr2" class = "tset4 float-left"></textarea></td>
							</tr>
      				...
      				<tr>
      					...
      					<td colspan = "2">
									<div class="filebox float-left"> 
      						<input class="upload-name" value="파일선택" disabled="disabled"> 
      						<label for="ex_filename05">업로드</label><input type="file" id="ex_filename05" class="upload-hidden"> </div>
      					</td>
      				</tr>
      				<tr>
      					<th width = "200px">실내 및 마당 사진3 :</th>
      					<td colspan = "2">
									<div class="filebox float-left"> 
      						<input class="upload-name" value="파일선택" disabled="disabled"> 
      						<label for="ex_filename06">업로드</label><input type="file" id="ex_filename06" class="upload-hidden"> </div>
      					</td>
      				</tr>
      				<tr>
      					<th>어필 사진1 :</th>
      					<td colspan = "2">
									<div class="filebox float-left"> 
      						<input class="upload-name" value="파일선택" disabled="disabled"> 
      						<label for="ex_filename07">업로드</label><input type="file" id="ex_filename07" class="upload-hidden"> </div>
      					</td>
      				</tr>
      				<tr>
      					<th>어필 사진2 :</th>
      					<td colspan = "2">
									<div class="filebox float-left"> 
      						<input class="upload-name" value="파일선택" disabled="disabled"> 
      						<label for="ex_filename08">업로드</label><input type="file" id="ex_filename08" class="upload-hidden"> </div>
      					</td>
      				</tr>
      				<tr>
      					<th>어필 사진3 :</th>
      					<td colspan = "2">
									<div class="filebox float-left"> 
      						<input class="upload-name" value="파일선택" disabled="disabled"> 
      						<label for="ex_filename09">업로드</label><input type="file" id="ex_filename09" class="upload-hidden"> </div>
      					</td>
      				</tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class = "row">
      		<div class = "col-3">
      			<div class = "float-left modalprofileimg aspect_1_1"><img src = "resources/images/person_2.jpg"></div>
      		</div>
      		<div class = "col-7">
						<div class = "float-left" style= "padding : 3px 0 0 3px; margin-left : 10px;">
							<table>
								<tr>
									<td colspan = "2" class = "font-size-15 main_grayfont3 mybold tleft">고객닉네임<td>
								<tr>
								<tr>
									<td class = "float-left" style = "padding: 0 0 7px 0;" >
										<% 
											int star4 = 4;
      		...
      		<div class = "col-12">
      			<table>
      				<tr>
      					<th class = "font-size-14">후기 : </th>
      					<td class = "tset2" width = "400px"> 후기기후기후기 후후기 후기후기후기후기후기 후기후기후기후기 후기후기후기후기후기 후기후기후기후기 후기후기후기후기후기 후기후기후기후기 후기후기후기후기후기 후기후기후기후기 후기후기후기후기후기 후기후기후기후기 후기후기후기후기후기 후기후기후기후기 후기후기후기후기후기 후기후기후기후기</td>
								
      				</tr>
							<tr>
								<th class = "font-size-14">답변 :</th>
								<td><textarea name="inputstr2" class = "tset3"></textarea></td>
							</tr>
