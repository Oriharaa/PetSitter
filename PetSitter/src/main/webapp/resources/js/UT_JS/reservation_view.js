...
<<<<<<< HEAD
					...
					var cert_check1 = "자격증 미보유";
					var cert_check2 = "";
						if(!item.petsitter_CERT_LIST === "N")
						{
							var cert_check1 = "자격증보유";
							var cert_check2 = "-";
						}
					...
					var output = '';
						...
						output += '<input type="hidden" name="photo_cert_File"  value="' + item.petsitter_PHOTO_CERT_FILE+ '">';
						output += '<input type="hidden" name="cert_list" value= "' + item.petsitter_CERT_LIST+ '">';
						output += '<input type="hidden" name="cert_check1" value="' + cert_check1+ '">';
						output += '<input type="hidden" name="cert_check2" value="' + cert_check2+ '">';
						...
						output += '</p>';
						output += '<p class="v_introduce">' + item.petsitter_INTRODUCE 
