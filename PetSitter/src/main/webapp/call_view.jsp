      				...
      				<div class = "col-10" style = "background : rgba(224, 224, 224, 0.65);  height : 100%;">
      					<div class = "row justify-content-center">
      						...
      						<div class = "col-12 text-center">
										<button type="button" style="background:#bebebe; color :white; width : 70px; height : 27px; margin : 8px 5px 0 0" class="btn btn-sm font-size-12">위탁</button>
										<button type="button" style="background:#53dc98; color :white; width : 70px; height : 27px; margin : 8px 0 0 0" class="btn btn-sm font-size-12">방문</button>
									</div>
									<div class = "col-12 text-center font-size-15 main_grayfont3 mybold" style = "margin-top : 8px;">
									펫시터 이용 날짜
									</div>
									<div class = "col-10 text-center" style = "padding : 0; margin : 4px 0 0 0;">
										<!-- 이용날짜 -->
										<input type="text" id="datePicker_start" class="form-control dateP" placeholder="날짜 선택" style = "height : 41px;">
									</div>
									...
									<div class = "col-11 text-center">
										<div class ="row justify-content-center">
											<div class = "col-5" style = "padding : 0; margin : 4px 0 0 0;">
												<!-- 방문 체크인 시간 -->
												<input type="text" name="time" class="form-control timepicker2 dateP" id="timePicker_start" value="00:00" style = "height : 41px;">
											</div>
											...
											<div class = "col-5" style = "padding : 0; margin : 4px 0 0 0;">
												<!-- 방문 체크아웃 시간 -->
												<input type="text" name="time" class="form-control timepicker2 dateP" id="timePicker_end" value="00:00" style = "height : 41px;">
											</div>
										</div>
									</div>
									<div class = "col-12 text-center font-size-15 main_grayfont3 mybold" style = "margin-top : 8px;">
									...
									<div class = "col-11 text-center font-size-12 main_grayfont3" style = "margin : 5px 0 0 0;">
										<div class = "petcost">
											<div>아지, 총 3시간, 비용 : 35,000원</div>
											<div>초코, 대형, 총 3시간, 비용 : 35,000원</div>
											<div>아지 산책 30분 넣기 (+5000원)</div>
											<div>초코(대형견) 산책 30분 넣기 (+7000원)</div>
